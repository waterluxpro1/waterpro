...
export const ContactForm = () => {
	...
	const [translations, setTranslations] = useState<Record<string, unknown> | undefined>({})

	useEffect(() => {
		(async () => {
			const translations = await wordpress.getTranslations('contact-form', locale.toString())
	...
	return (
		<div>
			...
			<form className={styles.form} action="">
				...
				<div className={styles.block}>
					<Input name="phone" autoComplete="tel" placeholder={getKeyIfItIsExists(translations, 'phone')} required />
